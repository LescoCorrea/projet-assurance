        ...
        <div id="heroCarousel" className="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
          ...
          <div className="carousel-item active">
            <div className="carousel-container">
              <h2 className="animate__animated animate__fadeInDown">Bienvenue à <span>SUNU ASSURANCE</span></h2>
              <p className="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
              <a href="/" className="btn-get-started animate__animated animate__fadeInUp">En savoir plus</a>
            </div>
          </div>
      ...
      <div className="container">
        ...
        <div className="row" data-aos="fade-up">
          <div className="col-md-5">
            <img src="bak-stores/img/features-1.svg" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row" data-aos="fade-up">
          <div className="col-md-5 order-1 order-md-2">
            <img src="bak-stores/img/features-2.svg" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row" data-aos="fade-up">
          <div className="col-md-5">
            <img src="bak-stores/img/features-3.svg" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row" data-aos="fade-up">
          <div className="col-md-5 order-1 order-md-2">
            <img src="bak-stores/img/features-4.svg" className="img-fluid" alt=""/>
          </div>
          <div className="col-md-7 pt-5 order-2 order-md-1">
